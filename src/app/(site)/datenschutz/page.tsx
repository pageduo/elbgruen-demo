...
export const metadata: Metadata = {
  title: "Datenschutzerklärung (Platzhalter) — ELBGRÜN Demo",
};
      ...
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8">
        <div className="flex flex-col gap-10 text-sm leading-relaxed text-stone">
          ...
          <section>
            ...
            <p>
              Die verwendeten Schriftarten (Manrope, Inter) werden über <code>next/font</code>{" "}
          ...
          <section id="cookies">
            ...
            <p>
              ...
              Einbindung der Google-Maps-Karte im Kontaktbereich fragen wir vor dem Laden separat
              Ihre Zustimmung ab, da hierbei Ihre IP-Adresse an Google übertragen wird.
            </p>
            <div className="mt-4">
              <ResetConsentButton />
            </div>
