...
export default function Testimonials() {
  return (
    <section id="stimmen" className="bg-paper py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <Reveal>
          <p className="eyebrow text-brass-dark">// Stimmen unserer Kunden</p>
        ...
        <div className="mt-14 grid grid-cols-1 gap-8 lg:grid-cols-3">
          {testimonials.map((t, i) => (
            ...
            >
              <p className="font-display text-lg leading-relaxed text-ink">“{t.quote}”</p>
