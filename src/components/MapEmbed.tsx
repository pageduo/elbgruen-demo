...
export default function MapEmbed() {
    ...
    return (
      <div className="relative flex aspect-[4/3] w-full flex-col items-center justify-center gap-4 rounded-3xl bg-mist p-8 text-center">
        ...
        <button
          ...
          className="rounded-full bg-forest px-6 py-3 text-sm font-semibold text-paper transition hover:bg-ink"
        >
  ...
  return (
    <div className="aspect-[4/3] w-full overflow-hidden rounded-3xl">
      <iframe
        title="Anfahrt ELBGRÜN Gartenmanufaktur"
        src="https://www.google.com/maps?q=Elbchaussee+118+Hamburg&output=embed"
