...
export default function LegalHero({ eyebrow, title }: { eyebrow: string; title: string }) {
  return (
    <div className="bg-forest pb-16 pt-32 sm:pt-40">
      <div className="mx-auto max-w-3xl px-5 sm:px-8">
        ...
        <div className="mt-6 rounded-2xl border border-brass-light/30 bg-brass/10 px-5 py-4 text-sm leading-relaxed text-paper/80">
